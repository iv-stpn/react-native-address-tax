...
const LEVEL1_OPTIONS: Partial<Record<SupportedCountryCode, ReadonlyArray<AdministrativeDivisionOption>>> = {
  ES: level1Admin_ES,
  GB: level1Admin_GB,
  IT: level1Admin_IT,
  US: level1Admin_US,
...
const CURATED_FIELD_ORDER: Partial<Record<SupportedCountryCode, AddressFieldKey[]>> = {
...
export const COUNTRIES_ADDRESSES = Object.fromEntries(SUPPORTED_COUNTRY_CODES.map((code) => [code, buildConfig(code)])) as Record<
