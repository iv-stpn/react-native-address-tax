...
const countriesSrc = readFileSync(resolve(__dirname, "../src/utils/countries.ts"), "utf8");
const block = countriesSrc.slice(countriesSrc.indexOf("COUNTRY_CODES = ["), countriesSrc.indexOf("] as const"));
...
const files = {
  ...
  "AddressTax.B2B.stories.tsx": genTax("business", "Address+Tax / Business to business"),
  "AddressTax.B2C.stories.tsx": genTax("individual", "Address+Tax / Business to consumer"),
